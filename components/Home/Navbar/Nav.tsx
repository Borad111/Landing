    ...
    <div className={`transition-all ${navBg ? 'bg-white  shadow-md' : "fixed" }  duration-200 h-[12vh] z-[100] fixed w-full`}>
      <div className='flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto'>
        ...
        <div className='flex items-center space-x-2'>
            <div className='w-12  h-12 bg-blue-800 rounded-full flex items-center justify-center flex-col'>
                <GrTechnology className='w-7 h-7 text-white'/>
            </div>
            <h1 className='text-xl  hidden sm:block md:text-2xl font-bold text-blue-800'>Tech Dev</h1>
        </div>
...
<HiBars3BottomRight onClick={openNav} className='w-8 h-8 hover:cursor-pointer  text-black  lg:hidden '/>
        </div>
      </div>
    </div>
  )
